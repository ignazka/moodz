    ...
    <div className='Auth'>
      <Card sx={{ padding: '2em', margin: 'auto' }}>
        <form className='auth-form' onSubmit={handleSubmit(onSubmit)}>
          ...
          {errors.password && (
            <p className='error-text'>Your password must contain between 4 and 60 characters.</p>
          )}
          ...
          {error && <p className='error-text firebase-error'>{error}</p>}
          ...
          {login ? (
            <div className='auth-link-ctn'>
              <p>
                <span>New to moodZ?</span> 
                <Link className='auth-link' to='/signup' onClick={() => setLogin(false)}>Create an account</Link>
              </p>
            </div>
          ) : (
            <div className='auth-link-ctn'>
              <p>
                ...
                <Link className='auth-link' to='/login' onClick={() => setLogin(true)}>Sign in</Link>
              </p>
            </div>
          )}
        </form>
